...
export function mapToDemoAuthEkycDetails(data) {
    ...
    demoAuth.NameMatchStatus = data?.NameMatchScore ?? "";
    demoAuth.TxnDateTime = data?.NameMatchScore ?? "";
    demoAuth.TxnNo = data?.NameMatchScore ?? "";
    demoAuth.UIDToken = data?.NameMatchScore ?? "";
    demoAuth.VaultRefNumber = data?.NameMatchScore ?? "";
    return demoAuth;
};
